( function( $ ) {
	...
	Quickpay.prototype.request = function( dataObject ) {
		...
		var request = $.ajax( {
			...
			dataType: 'json',
			data : $.extend( {}, { 
                action : 'quickpay_manual_transaction_actions',
                quickpay_transaction_id: that.actionBox.attr('data-transaction-id'),
                quickpay_log_id: that.actionBox.attr('data-log-id')
            }, dataObject ),
